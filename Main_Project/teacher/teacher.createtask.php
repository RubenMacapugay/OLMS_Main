                ...
                <div class="custom-border mt-4">
                    ...
                    <form method='POST' action='../../includes/teacher.createtask.inc.php'>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <label for="inputAssignmentDescription" class="form-label mb-0">Task
                                            Name</label>
                                        <input type="name" class="form-control" name="taskname" id="inputAssignmentDescription" aria-describedby="taskname" placeholder="sample: 01 Quiz 01">
                                    </div>

                                    <!-- Task Content for Essay -->
                                    <div class="mb-3 ps-0" id="taskcontentDiv">
                                        <label for="">Task Content</label>
                                        <textarea class="form-control" name="taskcontent" placeholder="Content Description" id="floatingTextarea"></textarea>
                                    </div>

                                    <!-- Question Items -->
                                    <div class="mb-3 w-50" id="questionItemsDiv">
                                        <label for="">Question items</label>
                                        <input type="number" class="form-control" name="questionitems" placeholder="0"></input>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <select class="form-select" name="subtype" id="subtype" onchange="showDiv(this)">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <!-- Start Duration -->
                                            <input type="date" class="form-control" name="datecreated" id="inputStartDate">
                                            <span class="mx-2">to</span>
                                            <!-- End Duration -->
                                            <input type="date" class="form-control" name="datedeadline" id="inputEndDate">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="number" class="form-control" name="maxattempts" id="inputMaxScore">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-6 mb-3 " id="inputMaxScoreDiv">
                                            ...
                                            <input type="number" class="form-control" name="maxscore" id="inputMaxScore">
                                        </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="mt-1">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" name="submissionchoice" type="radio" id="radioYes" checked value="Yes">
                                                    <label class="form-check-label" for="radioYes">
                                                        Yes
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" name="submissionchoice" type="radio" id="radioNo" value="No">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="teacher.subject.php"><button type="button" class="btn btn-secondary">Close</button></a>
                            <!-- Multiple Choice -->
                            <button type="submit" name="createQuestionTask" class="btn btn-primary ms-2 custom-hide" id="createBtn">Proceed
                                to Multiple Choice</button>
                            <!-- Identification -->
                            <button type="submit" name="createIdentificationTask" class="btn btn-primary ms-2 custom-hide" id="createIdentificationBtn">Proceed
                                to indentification</button>
                            <!-- Enumeration -->
                            <button type="submit" name="createEnumeration" class="btn btn-primary ms-2 custom-hide" id="createEnumerationBtn">Proceed
                                to Enumeration</button>
                            <!-- True or False -->
                            <button type="submit" name="createTrueOrFalse" class="btn btn-primary ms-2 custom-hide" id="createTrueOrFalse">Proceed
                                to True or False</button>
                            <!-- Essay -->
                            <button type="submit" name="createEssay" class="btn btn-primary ms-2" id="createWithQuestionBtn">Create Essay</button>
                        </div>
                    </form>
                </div>
            </div>
