   ...
   <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <!-- <li class="nav-item">
       ...
       <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
         <div class="bg-white py-2 collapse-inner rounded">
           <h6 class="collapse-header">Management Accounts</h6>
           <a class="collapse-item" href="register.php">Admin Profiles</a>
           <a class="collapse-item" href="teacher.head.php">Subject Head Teacher</a>
           <a class="collapse-item" href="#">Student Profiles</a>
      <a class="collapse-item" href="#">Parent Profiles</a>
         </div>
       </div>
     </li> -->
    ...
    <div id="collapseModule" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Module Management</h6>
        <a class="collapse-item" href="Modules.php">Subjects</a>
        <a class="collapse-item" href="#">Student Enrolled Subjects</a>
      </div>
    </div>
  </li> -->
