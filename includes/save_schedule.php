...
if($_SERVER['REQUEST_METHOD'] !='POST'){
    echo "<script> alert('Error: No data to save.'); location.replace('../Main_Project/teacher/teacher.calendar.php') </script>";
    $conn->close();
    exit;
}
extract($_POST);
...
$save = $conn->query($sql);
if($save){
    echo "<script> alert('Schedule Successfully Saved.'); location.replace('../Main_Project/teacher/teacher.calendar.php') </script>";
}else{
    echo "<pre>";
