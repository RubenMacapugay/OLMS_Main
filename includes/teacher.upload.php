...
if(isset($_POST['btnUpload']))
{
    ...
    $moduleGradingId = $_POST['uploadModuleGradingId'];
    $moduleUploadId = $_POST['uploadModuleUploadId'];
    $moduleSubjectListId = $_POST['uploadModuleSubjectList'];
    ...
    {
        $query = "INSERT INTO module_tbl (`module_name`,`fk_subject_list_id`,`module_file`,`fk_module_section_id`,`fk_grading_id`) 
                                    VALUES ('$name','$moduleSubjectListId', '$upload_files','$moduleUploadId','$moduleGradingId')";
